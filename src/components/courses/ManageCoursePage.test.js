...
//shallow testing the immediate component
//mount covers deeper level ,including the children component in memory ,testing the actually dom created
...
function render(args) {
    ...
    return mount(<ManageCoursePage {...props} />); //here I am referencing the unconnected component 
  }
